...
object LegalCopy {
    const val AGREEMENT_VERSION = "v1"
    const val UPDATED_AT = "2025年1月"
    ...
    const val PURCHASE_CONFIRM_CONTENT =
        "您将购买的是「小程序内容访问激活码」，不是游戏内自动改帧或性能提升服务。\n\n" +
        "· 方案需您在游戏中自行手动设置\n" +
        "· 效果因机型、网络、游戏版本而异，我们不作效果保证\n" +
        "· 激活码一经使用通常不可退换，请妥善保管\n" +
        "· 购买链接将在浏览器打开，请认准官方渠道\n\n" +
    ...
    private val userAgreement = listOf(
        LegalSection(
            heading = "一、服务性质",
            paragraphs = listOf(
                "「画质怪兽」（以下简称「本产品」）是由运营方提供的第三方玩家参考工具小程序，与《三角洲行动》及任何游戏开发商、发行商、官方平台均无隶属、授权或合作关系。",
        ...
        LegalSection(
            heading = "三、账号与内容访问",
            paragraphs = listOf(
                "您可通过完成任务或输入有效激活码的方式，开通本产品内相应参考内容的访问权限。",
                "「激活」「开通」均指本产品内的数字化内容访问权限，不包含任何游戏内道具、会员或官方服务。",
                "运营方有权根据业务需要调整免费与付费内容的范围，并将在合理范围内通过小程序公告等方式告知。",
            ),
        ),
        LegalSection(
            heading = "四、用户行为规范",
            paragraphs = listOf(
                ...
                "您应妥善保管激活码及设备信息，因个人泄露、转售激活码导致的损失由您自行承担。",
            ),
        ),
        LegalSection(
            heading = "五、知识产权",
        ...
        LegalSection(
            heading = "六、协议变更与终止",
            paragraphs = listOf(
                "运营方可适时修订本协议，修订后将通过小程序内适当位置公布。若您继续使用本产品，即视为接受修订后的协议。",
                "若您不同意本协议，请停止使用本产品。",
            ),
        ),
        LegalSection(
            heading = "七、联系我们",
            paragraphs = listOf(
                "如有疑问，请通过小程序「我的 - 意见反馈」联系我们，反馈类型可选择「激活/购卡问题」。",
                "公众号：画质怪兽（hzgsapp）",
            ),
        ),
    )
    ...
    private val privacyPolicy = listOf(
        LegalSection(
            ...
            paragraphs = listOf(
                ...
                "· 使用记录：您在本小程序内保存的方案、应用历史等（默认存于本机）。",
            ),
        ),
        LegalSection(
            heading = "二、信息的使用",
        ...
        LegalSection(
            ...
            paragraphs = listOf(
                ...
                "我们将采取合理措施保护信息安全，但无法保证绝对安全。请您妥善保管设备及激活码。",
            ),
        ),
        LegalSection(
            heading = "四、您的权利",
            paragraphs = listOf(
                ...
                "若您停止使用本产品，可清除小程序缓存或删除小程序以移除本地数据。",
            ),
        ),
        LegalSection(
            heading = "五、未成年人保护",
    ...
    private val paymentTerms = listOf(
        LegalSection(
            heading = "一、您购买的是什么",
            paragraphs = listOf(
                "通过激活码（卡密）购买的是「画质怪兽小程序内参考内容的访问权限」，属于数字化虚拟服务。",
        ...
        LegalSection(
            ...
            paragraphs = listOf(
                ...
                "购买激活码适用于希望跳过任务、直接开通的用户。免费与付费开通的内容访问范围以产品内实际展示为准。",
            ),
        ),
        LegalSection(
            heading = "三、购买与激活流程",
            paragraphs = listOf(
                "激活码可能通过第三方网页购买（复制链接后在浏览器打开）。请认准官方渠道，谨防诈骗。",
                "购买后，请在本小程序「卡密激活」页面输入激活码。每张激活码通常仅可使用一次，绑定设备后请妥善保管。",
                "若激活失败，请检查卡密是否输入正确、是否已被使用，并通过「意见反馈 - 激活/购卡问题」联系我们。",
            ),
        ),
        LegalSection(
            heading = "四、退款与争议",
            paragraphs = listOf(
                "数字化激活码一经成功激活，通常不支持退款，法律法规另有规定或双方另有约定的除外。",
                "若因系统故障导致重复扣费或未到账激活码，请保留购买凭证并通过意见反馈联系我们，我们将核实后协助处理。",
        ...
        LegalSection(
            ...
            paragraphs = listOf(
                ...
                "请尽量提供：购买时间、卡密后四位（勿公开完整卡密）、问题描述与截图。",
                "公众号：画质怪兽（hzgsapp）",
            ),
        ),
    )
