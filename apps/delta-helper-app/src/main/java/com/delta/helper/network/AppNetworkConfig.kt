...
class AppNetworkConfig @Inject constructor() : NetworkConfig {
    override val baseUrl: String = HelperBuildFlags.apiBaseUrl
    override val headers: Map<String, String> = mapOf(
        "X-App-Id" to BuildConfig.APPLICATION_ID,
        "X-Client-Version" to BuildConfig.VERSION_NAME,
    )
    override val hostHeader: String? = HelperBuildFlags.apiHostHeader
    ...
    override val loggingEnabled: Boolean = HelperBuildFlags.httpLoggingEnabled
}
